  ...
  return (
    <>
      <button
        ...
        className="animation bg-black text-white text-sm flex items-center gap-2 rounded-lg px-4 py-3 hover:opacity-80"
      >
        <span>
        ...
        >
          ...
          >
            ...
            <form className="mt-10 space-y-6" onSubmit={handleSubmit}>
              ...
              <div className="flex flex-col gap-3">
                <label className="text-sm text-gray-500">Free Delivery </label>
                <Select
                  name="freeDelivery"
                  value={freeDelivery}
              ...
              <div className="flex flex-col gap-3">
                <label className="text-sm text-gray-500">Weight Class</label>
                <Select
                  name="weightClass"
                  value={weightClass}
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="space-y-4">
                  {properties.map((item, index) => (
                    ...
                    >
                      <input
                        ...
                        className="w-full text-sm font-medium border border-input rounded-lg px-3 py-2 placeholder:text-sm placeholder:font-normal outline-none focus:border-default"
                      />
                      <input
                        type="text"
                  ...
                  <Button
                    ...
                    className="flex items-center gap-1.5 bg-gray-100 text-gray-500 text-sm font-normal border border-dashed border-gray-300 hover:bg-gray-100"
                  >
              ...
              <div className="flex flex-col gap-3">
                ...
                <div className="flex items-center flex-wrap gap-4">
                    ...
                    <div className="flex flex-wrap gap-4">
                      {images.map((img, index) => (
                        <div key={index} className="relative">
                          <div className="w-36 h-36 bg-gray-100 flex items-center justify-center text-sm text-gray-500 rounded-lg border border-dashed border-gray-200">
                            <img
                              src={img}
                              alt="Product Image"
                  ...
                  <label className="w-36 h-36 bg-gray-100 flex flex-col gap-1 items-center justify-center text-sm text-gray-500 rounded-lg border border-dashed border-gray-200 cursor-pointer">
                    <BsCloudUpload />
                    upload
                    <input
                      type="file"
