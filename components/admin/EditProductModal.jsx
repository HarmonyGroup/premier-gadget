      ...
      >
        ...
        >
          ...
          <form onSubmit={handleSubmit} className="mt-10 space-y-6 text-left">
            ...
            <div className="flex flex-col gap-3">
              <label className="text-sm text-gray-500">Product Condition</label>
              <Select
                name="condition"
                value={condition}
                ...
                {properties.map((item, index) => (
                  <div key={item.id} className="flex items-center gap-4">
                    <input
                      ...
                      className="text-sm font-medium border border-input rounded-lg px-3 py-2 placeholder:text-sm outline-none focus:border-default"
                    />
                    <input
                      type="text"
