      ...
      <div className="grid grid-cols-3 items-center gap-5 md:gap-10 px-4 md:px-10 py-5 md:py-10">
        <div className="col-span-3 md:col-span-1 h-full">
          <div className="bg-white rounded-lg p-5">
            <h1 className="text-lg md:text-xl font-bold">ICM Store</h1>
            <p className="text-gray-500 text-sm md:text-[16px] mt-2.5">
              Unit L94, Ikeja City Mall, 176/194 Obafemi Awolowo Way Alausa,
              Lagos
            </p>
            <p className="text-blue-500 text-sm md:text-[16px] mt-2.5">08173630234</p>
          </div>
        </div>

        <div className="col-span-3 md:col-span-1 h-full">
          <div className="bg-white rounded-lg p-5">
            <h1 className="text-lg md:text-xl font-bold">Computer Village Store</h1>
            <p className="text-gray-500 text-sm md:text-[16px] mt-2.5">
              4, Francis Oremeji street, off Simbiat Abiola way, Ikeja, Lagos
            </p>
            <p className="text-blue-500 text-sm md:text-[16px] mt-2.5">08186700678</p>
          </div>
        </div>
        <div className="col-span-3 md:col-span-1 h-full">
          <div className="bg-white rounded-lg p-5">
            <h1 className="text-lg md:text-xl font-bold">Abuja Store</h1>
            <p className="text-gray-500 text-sm md:text-[16px] mt-2.5">
              Unit 19B Jabi Lake Mall, Plot 1260 Jabi District, Cadastral Zone
              BO4 FCT
            </p>
            <p className="text-blue-500 text-sm md:text-[16px] mt-2.5">08173477775</p>
          </div>
        </div>
      </div>
    </div>
